...
// toolchain (`svelte/`) has been removed. Whether and how to revive this
// handler (e.g. as a plain Cloudflare Worker fetch handler) is an
// unresolved product decision, outside the scope of this frontend
// migration.
